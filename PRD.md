...
- [ ] `Shift+T` opens themes panel
- [ ] Lists themes with entry count
- [ ] Shows top 5 keywords per theme
- [ ] Select theme to filter entries by that theme
- [ ] Themes generated by BERTopic (see F3.1)
